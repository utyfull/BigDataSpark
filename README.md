...
Spark читает исходные CSV-файлы, загружает staging-таблицу в PostgreSQL, строит модель данных "звезда", а затем формирует аналитические отчеты и записывает их в ClickHouse.
